...
export function Footer() {
  return (
    <footer className="border-t border-neutral-950/10 bg-neutral-950 text-cream">
      <div className="site-footer-main mx-auto grid max-w-7xl gap-12 px-5 py-16 sm:px-8 lg:grid-cols-[1.2fr_0.8fr] lg:px-10 lg:py-20">
        ...
        <div className="site-footer-links grid gap-6 sm:grid-cols-2 lg:justify-self-end">
          <div>
